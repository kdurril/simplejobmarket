...
class Positions(db.Model):
    ...
    positionapp = db.relationship('PositionApps', backref='Positions')
...
class Supervisors(db.Model):
    ...
    position = db.relationship('Positions', 
        backref=db.backref('Supervisors', lazy='joined'), lazy='dynamic')

    def __init__(self, supervisor_id=None, 
                name_last=None, name_first=None,
                phone=None, email=None,
                room=None, center=None, position=None):
        self.supervisor_id = supervisor_id
        self.name_last = name_last
...
#positionApps = db.Table('positionApps',
#    db.Column('app_id', db.Integer, primary_key=True),
#    db.Column('student_uid', db.Integer, db.ForeignKey('students.student_uid')),
#    db.Column('position_id', db.Integer, db.ForeignKey('positions.position_id'))
#)
